...
$uploadpath = 'Direct_upload//16/';      // directory to store the uploaded files
...
//  ********************************************
     ...
     $data = array('uid'=>'0'.(string)$row["uid"],'folder'=>'16','fname'=>(string)$namefile,'appk'=>(string)$row["appKey"]);
   //echo "ud: " . $row["uid"]. " - Name: " . $row["appKey"]. "<br>";

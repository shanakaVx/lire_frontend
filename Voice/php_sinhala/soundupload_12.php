...
$uploadpath = 'Direct_upload//12/';      // directory to store the uploaded files
...
//  ********************************************
     ...
     $data = array('uid'=>'0'.(string)$row["uid"],'folder'=>'12','fname'=>(string)$namefile,'appk'=>(string)$row["appKey"]);
   //echo "ud: " . $row["uid"]. " - Name: " . $row["appKey"]. "<br>";
